...
tanzu package repository add tanzu-tap-repository --url registry.tanzu.vmware.com/tanzu-application-platform/tap-packages:1.3.0 --namespace tap-install
...
tanzu package install tap -p tap.tanzu.vmware.com -v 1.3.0 --values-file $HOME/tap-script/tap-values.yaml -n tap-install
